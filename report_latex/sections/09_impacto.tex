...
\begin{frame}{Impacto Esperado - Conclusiones}
    \begin{block}{Resumen del Proyecto}
        \begin{itemize}
            \item \textbf{Problema}: tasa de churn de \churnrate
            \item \textbf{Solución}: modelo predictivo basado en Regresión Logística y Random Forest para comparar desempeño
            \item \textbf{Resultado}: Recall de 0.559 para la clase Fuga con Regresión Logística y AUC de 0.8421
            \item \textbf{Impacto}: intervención temprana sobre clientes de alto riesgo para reducir la fuga en el segmento objetivo
        \end{itemize}
    \end{block}
